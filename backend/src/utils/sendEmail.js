...
const sendContactNotification = async (contactData) => {
    ...
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; background: #f9f9f9; padding: 20px; border-radius: 8px;">
        ...
        <div style="background: white; padding: 30px; border-radius: 0 0 8px 8px;">
          <table style="width: 100%; border-collapse: collapse;">
            ...
            <tr>
              ...
              <td style="padding: 12px 0; color: #333; line-height: 1.6;">${escapeHtml(contactData.message).replace(/\n/g, "<br/>")}</td>
            </tr>
          </table>
          <div style="margin-top: 20px; padding: 15px; background: #f0f0ff; border-radius: 6px; border-left: 4px solid #7c5cff;">
            <p style="margin: 0; color: #555; font-size: 14px;">
              ...
              <strong>IP Address:</strong> ${escapeHtml(contactData.ipAddress) || "Unknown"}
            </p>
          </div>
        ...
        <p style="text-align: center; color: #999; font-size: 12px; margin-top: 20px;">
          HEROY Digital Solutions — Injibara, Ethiopia
        </p>
      </div>
    `,
  };
  ...
  const clientMailOptions = {
    ...
    subject: "We received your message — HEROY Digital Solutions",
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; background: #f9f9f9; padding: 20px; border-radius: 8px;">
        <div style="background: linear-gradient(135deg, #7c5cff, #22d3ee); padding: 20px; border-radius: 8px 8px 0 0; text-align: center;">
          <h1 style="color: white; margin: 0; font-size: 24px;">HEROY Digital Solutions</h1>
        ...
        <div style="background: white; padding: 30px; border-radius: 0 0 8px 8px;">
          ...
          <p style="color: #555; line-height: 1.7;">
            Thank you for reaching out to HEROY Digital Solutions. We have received your message and our team will review it shortly.
          </p>
          <p style="color: #555; line-height: 1.7;">
          ...
          <p style="color: #555; line-height: 1.7;">
            If you have any urgent questions, you can also reach us on WhatsApp at <strong>+251 900 000 000</strong> or Telegram at <strong>@HEROY_Team</strong>.
          </p>
          <p style="color: #555; line-height: 1.7;">
            Best regards,<br/>
            <strong>The HEROY Digital Solutions Team</strong>
          </p>
        </div>
        <p style="text-align: center; color: #999; font-size: 12px; margin-top: 20px;">
    ...
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        <div style="background: linear-gradient(135deg, #7c5cff, #22d3ee); padding: 20px; border-radius: 8px 8px 0 0; text-align: center;">
          ...
          <p style="color: rgba(255,255,255,0.8); margin: 5px 0 0 0; font-size: 13px;">HEROY Digital Solutions</p>
        </div>
