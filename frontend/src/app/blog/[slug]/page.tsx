      ...
      <section className="section pt-0 relative">
        <div className="container-px mx-auto max-w-3xl">
          <motion.div
            ...
            className="hy-holo-container mb-14"
          >
            ...
            <div className="relative">
              <h2 className="font-display font-bold text-xl sm:text-2xl text-white mb-3">
                ...
                <span className="hy-grad-text-flow">practice?</span>
              </h2>
          ...
          <div className="grid sm:grid-cols-3 gap-4">
            {relatedPosts.map((rp, i) => (
              ...
              >
                <Link
                  href={`/blog/${rp.slug}`}
                  className="hy-holo-inner group block"
                >
                  ...
                  <div className="p-4">
                    ...
                    <span className="text-[10px] flex items-center gap-1" style={{ color: "#9292b8" }}>
