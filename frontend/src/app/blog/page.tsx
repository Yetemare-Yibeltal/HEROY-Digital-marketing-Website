...
// ⚠️ NOTE: "digital-marketing-strategy-b2b" and "ecommerce-conversion-rate-optimization"
// below make specific first-person client-result claims ("we used", "we applied to a
// client's store") with invented numbers. Same risk category as the portfolio section —
// replace with real case data, or reframe as general/illustrative advice, before launch.
const posts: Post[] = [
  {
        ...
        <div className="container-px mx-auto max-w-4xl text-center">
          ...
          >
            <span className="badge mb-4">
              <Sparkles size={14} /> HEROY Digital Solution Blog
            </span>
          </motion.div>
          ...
          <motion.div layout className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            <AnimatePresence mode="popLayout">
              {filtered.map((post, i) => (
                ...
                >
                  <Link href={`/blog/${post.slug}`} className="hy-holo-inner group block">
                    ...
                    <div className="p-5">
                      <div className="flex items-center gap-3 text-xs mb-3" style={{ color: "#9292b8" }}>
                      ...
                      <p className="text-xs leading-relaxed line-clamp-2 mb-4" style={{ color: "#9292b8" }}>
                        {post.excerpt}
                      </p>
