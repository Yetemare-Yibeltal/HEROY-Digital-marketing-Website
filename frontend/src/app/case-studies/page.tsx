...
// ⚠️⚠️ HIGHEST PRIORITY CONTENT FLAG IN THIS CODEBASE ⚠️⚠️
// All 9 "case studies" below (client names, challenges, solutions, and every
// metric) are entirely fabricated. The original page headline literally said
// "Real projects, real Results" over this invented content — that specific
// false claim has been fixed below, but the underlying fake client data is
// still here and MUST be replaced with real projects before this page goes
// live. Publishing detailed fake case studies is a materially higher legal/
// trust risk than the homepage portfolio tiles or blog posts.
const caseStudies = [
  {
    id: "nexora-saas",
    client: "Nexora Tech",
    ...
    <div className="relative overflow-hidden">
      ...
      <section className="section pt-36 pb-10 relative">
        <div className="container-px mx-auto max-w-4xl text-center">
          ...
          >
            Case studies designed to drive{" "}
      ...
      <section className="section pt-0 relative">
        <div className="container-px mx-auto max-w-6xl flex flex-col gap-12">
          {caseStudies.map((cs, i) => (
            ...
            >
              <div className="hy-holo-inner relative">
              ...
              <div className="p-8 sm:p-10">
                    ...
                    {cs.results.map((r) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <p className="text-[10px] mt-1" style={{ color: "#9292b8" }}>{r.label}</p>
                        </div>
                      );
                    })}
                  </div>
                ...
                <div className="grid sm:grid-cols-2 gap-6 mb-6">
                  <div>
                    <h3 className="text-xs font-bold uppercase tracking-widest mb-2" style={{ color: "#9292b8" }}>
                      The Challenge
                    </h3>
          ...
          <div className="hy-holo-container">
            ...
            <div className="relative">
              <h2 className="font-display font-bold text-2xl sm:text-3xl lg:text-4xl mb-4 text-white">
                ...
                <span className="hy-grad-text-flow">success story?</span>
              </h2>
