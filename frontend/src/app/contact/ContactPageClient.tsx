...
const quickFaqs = [
  {
    ...
    a: "Within 24 hours on business days — usually much sooner.",
  },
  {
    q: "Is the consultation really free?",
    a: "Yes, a 30-minute discovery call with no cost and no obligation to move forward.",
  },
  {
    q: "Do I need a full brief ready?",
    a: "No — a rough idea is enough to start the conversation. We'll help you shape the scope.",
  },
];
        ...
        <div className="container-px mx-auto max-w-7xl">
          ...
          <div className="grid lg:grid-cols-[1fr_1.4fr] gap-10 mb-16">
            ...
            >
              ...
              <div className="glass rounded-2xl p-5 flex items-center gap-4">
                <Globe2 size={20} className="text-accent shrink-0" />
                <div>
                  <p className="text-sm font-semibold text-white">Office hours</p>
                  <p className="text-xs text-muted">Mon – Sat, 9:00 AM – 7:00 PM (EAT, UTC+3). Messages outside these hours are answered the next business day.</p>
                </div>
              </div>
              ...
              <div className="flex flex-col gap-2">
                ...
                <Link
                  href="/faq"
                  className="text-xs font-semibold text-accent inline-flex items-center gap-1 mt-1"
                >
                  See the full FAQ
                  <ArrowRight size={12} />
                </Link>
          ...
          >
            <div className="p-6 pb-4 flex items-center gap-3">
              ...
              <div>
                <p className="text-sm font-semibold text-white">Injibara, Awi Zone, Amhara Region, Ethiopia</p>
                <p className="text-xs text-muted">We work primarily remote, but we're happy to meet in person if you're nearby.</p>
              </div>
            </div>
            <iframe
              title="HEROY location — Injibara, Ethiopia"
