...
// ⚠️ NOTE: All 9 projects below are fabricated (fake company names + invented
// % results), same issue as the homepage PortfolioPreview and /case-studies.
// Replace with real project data before launch.
        ...
        <motion.div layout className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
          <AnimatePresence mode="popLayout">
            {filtered.map((project, i) => (
              ...
              >
                <div
                  className="hy-holo-inner group relative cursor-pointer"
                  style={{
                ...
                <div className="absolute inset-0 flex flex-col justify-between p-6">
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-2" title="Illustrative — not a real measured result">
