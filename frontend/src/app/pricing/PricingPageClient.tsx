...
const included = [
  { icon: FileCode2, label: "Full source code ownership" },
  { icon: Unlock, label: "No long-term lock-in contracts" },
  { icon: Users2, label: "Direct access to your dev team" },
  { icon: ShieldCheck, label: "NDA available on request" },
];

const addOns = [
  { name: "Extra page or section", price: "$99", note: "per page, beyond your plan's included pages" },
  { name: "Additional revision round", price: "$149", note: "per round, beyond your plan's included rounds" },
  { name: "Rush delivery", price: "+30%", note: "of project price, for accelerated turnaround" },
  { name: "Monthly care & maintenance", price: "From $149/mo", note: "updates, monitoring, small fixes, priority support" },
  { name: "Additional language / localization", price: "$199", note: "per language, including translated content" },
  { name: "Professional copywriting", price: "$79", note: "per page, written and optimized for your audience" },
];
...
const faqs = [
  ...
  },
  {
    ...
    a: "We accept bank transfer, Telebirr, PayPal, and Stripe. We typically work on a 50% deposit upfront and 50% on delivery, with milestone-based payments available for larger Enterprise projects.",
  },
  {
    q: "Are there ongoing monthly fees?",
    a: "The prices shown are one-time project fees. Ongoing hosting, domain, and maintenance are separate and optional — see the Monthly Care & Maintenance add-on above if you'd like us to continue handling it.",
  },
  {
  ...
  },
  {
    ...
    a: "Yes, completely. Once final payment is made, full ownership of the source code, design files, and content transfers to you — there's no ongoing licensing fee to keep using what we built.",
  },
  {
    q: "What happens if I need to cancel mid-project?",
    a: "You can cancel at any time. You keep whatever has been completed and delivered up to that point, and you're only billed for work already done — the deposit covers work already in progress, not future milestones.",
  },
];
      ...
      <section className="section pt-0 relative">
        <div className="container-px mx-auto max-w-7xl">
          ...
          <motion.div
            ...
            viewport={{ once: true, margin: "-60px" }}
            transition={{ duration: 0.5 }}
            className="flex flex-wrap items-center justify-center gap-6 mb-20 pb-10 border-b border-border"
          >
            {included.map((item) => {
          ...
          <div className="mb-20">
            ...
            >
              ...
              <p className="text-sm text-muted leading-relaxed">
                Need a bit more than your plan includes? Add exactly what
                you need, priced individually.
              </p>
            </motion.div>
              ...
              {addOns.map((addon, i) => (
                ...
                >
                  <div>
                    ...
                    <p className="text-xs text-muted mt-0.5">{addon.note}</p>
                  </div>
                  <span className="font-display font-bold text-accent text-base shrink-0">
                    {addon.price}
                  </span>
                </motion.div>
              ))}
